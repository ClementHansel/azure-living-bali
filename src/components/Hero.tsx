...
export default function Hero() {
  ...
  return (
    <section
      className="
        ...
        min-h-[200vh]
        md:min-h-[200vh]
        min-[0px]:min-h-screen
        relative overflow-hidden 
        font-inter lowercase
      "
    >
      {/* Sticky video wrapper */}
      <div className="sticky top-0 h-[200vh] md:h-[200vh] h-screen w-full">
        <video
          ref={videoRef}
        ...
        {/* LEFT INTRO TEXT — compact on mobile */}
        <div
          className="
    sticky top-0 
    h-screen 
  ...
  "
        ...
        {/* RIGHT MENU — compact + dynamic text color */}
        <div className="absolute bottom-10 right-6 md:bottom-20 md:right-16 z-30 text-right">
      ...
      >
        ...
        <span className="text-xs md:text-sm font-medium">Chat on WhatsApp</span>
      </a>
    </section>
  );
}
